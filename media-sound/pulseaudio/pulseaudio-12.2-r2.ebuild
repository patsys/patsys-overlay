...
SRC_URI="https://freedesktop.org/software/pulseaudio/releases/pulseaudio-12.2.tar.xz"
...
# Needed for patch pulseaudio-12.2-fix-alsa-includes-1.patch as part of bug #686206
DEPEND="${DEPEND}
	alsa? ( sys-devel/automake:1.15 )
"
